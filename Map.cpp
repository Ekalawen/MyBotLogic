...
map<int, Porte> Map::getPortes() {
    return portes;
}

Porte Map::getPorte(const int id) const noexcept {
    return portes.at(id);
}

Porte& Map::getPorte(const int tileIdVoisine1, const int tileIdVoisine2) noexcept {
